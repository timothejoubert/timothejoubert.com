...
medias:
  - sound_enabled: false
    file: media/media-0.gif
  - sound_enabled: false
    file: media/media-1.jpg
  - sound_enabled: false
    file: media/media-2.png
  - sound_enabled: false
...
Création de l'identité visuelle et d'un outil web interactif pour les journées portes ouvertes de La Martinière Diderot 2021.
