...
//     const locale = data && ((data.item as RoadizNodesSources)?.translation?.locale || (data.item as EventsApi.Event)?.locale)
//
//     if (locale) {
//         // Set currentPage data accessible in components layout
