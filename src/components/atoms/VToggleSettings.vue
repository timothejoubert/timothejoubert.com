<template>
    ...
    >
        <svg width="28" height="23" viewBox="0 0 28 23" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export default Vue.extend({
    ...
    methods: {
        toggleSettings() {
            this.$store.commit(MutationType.SPLASH_SCREEN_DONE, !this.isOpen)
        },
    },
})
</script>
